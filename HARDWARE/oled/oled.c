...
#define SCL_W	PDout(6)
#define SDA_W	PDout(7)	//PD7输出模式
#define SDA_R	PDin(7)		//PD7输入模式
...
//IIC Start
**********************************************/
void i2c_sda_mode(GPIOMode_TypeDef pin_mode)
{
...
{ 	
	...
	GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;		//推挽输出，增加驱动能力就是增加输出电流，还有吸收灌电流
	GPIO_InitStructure.GPIO_Speed = GPIO_High_Speed;	//工作速度100MHz，工作速度越高，功耗就会越高
	GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_NOPULL;	//不需要上下拉电阻
